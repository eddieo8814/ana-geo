...
const APP = process.env.DASH_URL || 'http://127.0.0.1:8806';
const STATE = process.env.MIRROR_STATE || '/tmp/ana-geo-satellite-mirror.json';
const LOCK = STATE + '.lock';
const WATCH_LOCK = STATE + '.watch';
const LOG = STATE.replace(/\.json$/, '') + '.log';
const OWN_DIR = /ana-geo-satellite(\/|$)/;
