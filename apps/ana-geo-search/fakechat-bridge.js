...
// 환경변수: DASH_URL(기본 http://127.0.0.1:8803), FAKECHAT_WS(기본 ws://127.0.0.1:8787/ws),
//          TAG(채널 접두 라벨, 기본 "ana-geo-search")
// 요구: Node >= 22 (전역 WebSocket). Node 20이면 relay.js를 쓰거나 22로 올릴 것.

const DASH = process.env.DASH_URL || 'http://127.0.0.1:8803';
const FC_WS = process.env.FAKECHAT_WS || 'ws://127.0.0.1:8787/ws';
const TAG = process.env.TAG || 'ana-geo-search';
